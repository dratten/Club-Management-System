                        ...
                        <?php foreach($files as $file){ 
                           ...
                           $file_ext=$file->file_ext;
                            ...
                            <span data-placement="top" data-toggle="tooltip" title="Delete Constitution">
                                <a  href="<?php echo base_url('index.php/Home/delete_constitution');?><?php echo "?constID="; echo  $file->autoID;?>"  style="text-decoration: none"><span><i class="fa fa-trash fa-lg" style="color:red"></i></span>
                                </a>
